...
define('CLASS_LOADER', require_once DOC_ROOT . '/vendor/autoload.php');
...
if (!function_exists('app')) {
     ...
     * @param bool|callable|null $concrete The concrete implementation or binding callback.
     * @return mixed The application instance or the requested service.
     */
    function app(string $class = null, bool|callable $concrete = null): mixed
    {
        static $app;
        if ($app === null) {
            if (!App::isBoot()) {
                ...
                return $app = App::boot($class, CLASS_LOADER);
            }
...
if (!function_exists('action')) {
    ...
    function action(string $route, array|ArrayAccess $args = null, array $context = null): ?ResponseInterface
    {
        ...
        return Route::matches($request)?->process($request);
    }
}
...
if (!function_exists('text')) {
    /**
     * Retrieve translated text or a default value.
     *
     * @param string $name The name of the text key to translate.
     * @param string|callable|null $default The default value or callable to provide the text if translation is missing.
     * @param array|ArrayAccess|null $args Optional arguments for the translation.
     * @param array|null $context Optional context for the translation.
     * @param object|null $scope Optional scope to bind if the default value is a callable.
     * @return string The translated or default text.
     */
    function text(string $name, string|callable $default = null, array|ArrayAccess $args = null, array $context = null, \object $scope = null): string
    {

        $translation = translate($name, $args, $context['domain'] ?? null);
        if (empty($translation)) {
            if (is_callable($default)) {
                $translation = call($default, $args, $context, $scope);
            } else {
                $translation = $default ?? '';
            }
        }

        return Event::filter($name, $translation);
    }
}

if (!function_exists('html')) {
    /**
     * Retrieve translated text or a default value and escape it for safe HTML output.
     *
     * @param string $name The name of the text key to translate.
     * @param string|callable|null $default The default value or callable to provide the text if translation is missing.
     * @param array|ArrayAccess|null $args Optional arguments for the translation.
     * @param array|null $context Optional context for the translation.
     * @param object|null $scope Optional scope to bind if the default value is a callable.
     * @return string The translated or default text, escaped for HTML.
     */
    function html(string $name, string|callable $default = null, array|ArrayAccess $args = null, array $context = null, \object $scope = null): string
    {
        return htmlspecialchars(text(...func_get_args()), ENT_QUOTES, 'UTF-8');
    }
}

if (!function_exists('attr')) {
    /**
     * Retrieve translated text or a default value, escape it for safe HTML attribute usage, and replace quotes.
     *
     * @param string $name The name of the text key to translate.
     * @param string|callable|null $default The default value or callable to provide the text if translation is missing.
     * @param array|ArrayAccess|null $args Optional arguments for the translation.
     * @param array|null $context Optional context for the translation.
     * @param object|null $scope Optional scope to bind if the default value is a callable.
     * @return string The translated or default text, escaped for HTML attributes and with quotes replaced.
     */
    function attr(string $name, string|callable $default = null, array|ArrayAccess $args = null, array $context = null, object $scope = null): string
    {
        return str_replace('"', '&quot;', html(...func_get_args()));
    }
}