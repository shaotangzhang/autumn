...
use Autumn\Attributes\Decorator;
    ...
    public function invoke(callable $callable, array|\ArrayAccess $args = [], array $context = []): mixed
    {
        try {
            if (is_array($callable)) {
                ...
                return $func->invoke($class, $this->injectParameters($func, $args, $context));
            }

            $func = new \ReflectionFunction($callable);
            return $func->invoke($this->injectParameters($func, $args, $context));
